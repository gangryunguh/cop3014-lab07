// This program will read in the quarter sales transactions for a given number
...
void   getSales(SalesType  table, int&  numOfYears)
{
    ...
    {
        cout << "Please input the year as a 4 digit number:  2004" << endl;
        cin >> table[row][0];

        for (int col = 1;  col < MAXCOL;  col++)
        {
            cout << "Please input the sales for quarter number " << col << endl;
            cin >> table[row][col];
        }
    }
}
